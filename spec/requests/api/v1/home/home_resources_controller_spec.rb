...
describe 'Api::V1::Home::Resources', type: :request do

  describe 'GET /api/v1/home/resources' do
    it 'returns status 200' do
      get '/api/v1/home/resources'
    ...
    context 'when "user_id" is provided in the request' do
      it 'returns trades of a given user only' do
        get '/api/v1/home/resources', params: {user_id: 201}
        #       # expected = [
        #       #   {
        #       #     id: 2,
        #       #     trade_type: 'buy',
    ...
    context 'when "trade_type" is provided in the request' do
      it 'returns trades of a given type only' do
        get '/api/v1/home/resources', params: {trade_type: :sell}
        #
        #       expected = [
        #         {
        #           id: 1,
  ...
  describe 'GET /api/v1/home/resources/:id' do
  ...
  describe 'POST /api/v1/home/resources' do
    it "is a pending example"
    # let(:shares) { 30 }
    # let(:trade_type) { 'buy' }
    # let(:trade_params) do
  ...
  describe 'DELETE /api/v1/home/resources/:id' do
    it "is a pending example"
    # let(:trade) do
    #   post '/trades', params: {
    #     trade_type: 'buy',
  ...
  describe 'PATCH /api/v1/home/resources/:id' do
    it "is a pending example"
    # let(:trade) do
    #   post '/trades', params: {
    #     trade_type: 'buy',
  ...
  describe 'PUT /api/v1/home/resources/:id' do
    it "is a pending example"
    # let(:trade) do
    #   post '/trades', params: {
    #     trade_type: 'buy',
