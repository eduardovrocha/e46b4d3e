...
describe 'Api::V1::Dashboard::ResourcesCon', type: :request do

  describe 'GET /api/v1/dashboard/resources' do
    it 'returns status 200' do
      get '/api/v1/dashboard/resources'
      expect(response.status).to eq(200)
    end
    # context 'when there are resources in the system' do
    #   # let(:trade_params) do
    #   #   [
    #   #     {
    #   #       trade_type: 'sell',
    ...
    #     end
    #   end
      it 'returns resources collection ordered by ID' do
        get '/api/v1/dashboard/resources'
    ...
    #     # expect(JSON.parse(response.body)).to eq(expected)
      ...
      context 'when "user_id" is provided in the request' do
        it 'returns trades of a given user only' do
          get '/api/v1/dashboard/resources', params: {user_id: 201}
    #       # expected = [
    #       #   {
    #       #     id: 2,
    #       #     trade_type: 'buy',
    ...
    #       # expect(JSON.parse(response.body)).to eq(expected)
      ...
      context 'when "trade_type" is provided in the request' do
        it 'returns trades of a given type only' do
          get '/api/v1/dashboard/resources', params: {trade_type: :sell}
    #
    #       expected = [
    #         {
    #           id: 1,
  ...
  describe 'GET /api/v1/dashboard/resources/:id' do
    it "is a pending example"
    # context 'when resource by given ID exists' do
    #   let(:trade_params) do
    #     {
    #       trade_type: 'sell',
    #       user_id: 100,
  ...
  describe 'POST /api/v1/dashboard/resources' do
    it "is a pending example"
    # let(:shares) { 30 }
    # let(:trade_type) { 'buy' }
    # let(:trade_params) do
  ...
  describe 'DELETE /api/v1/dashboard/resources/:id' do
    it "is a pending example"
    # let(:trade) do
    #   post '/trades', params: {
    #     trade_type: 'buy',
  ...
  describe 'PATCH /api/v1/dashboard/resources/:id' do
    it "is a pending example"
    # let(:trade) do
    #   post '/trades', params: {
    #     trade_type: 'buy',
  ...
  describe 'PUT /api/v1/dashboard/resources/:id' do
    it "is a pending example"
    # let(:trade) do
    #   post '/trades', params: {
    #     trade_type: 'buy',
